 ...
 */
package com.atul.Order.service;

import com.atul.Order.entity.Order;
import com.atul.Order.repository.OrderRepository;
import com.atul.Order.vo.Product;
import com.atul.Order.vo.ResponseTemplate;
...
@Autowired
    ...
    public void update(Long orderId,Integer jumlah,String tanggal, String status){
     ...
     public ResponseTemplate getOrderWithProductById(Long id){
         ...
         Product product = restTemplate.getForObject("http://localhost:9007/api/v1/product/" +order.getProductId(), Product.class);
